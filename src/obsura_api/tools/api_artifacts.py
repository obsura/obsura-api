...
REQUEST_EXTRACTORS: dict[tuple[str, str], list[dict[str, Any]]] = {
    ("GET", "/api/v1/studio/patterns"): [
        {"variable": "patternId", "paths": [[0, "id"]]},
        {"variable": "patternIdsJson", "paths": [["__collect__", "id"]]},
    ],
    ("POST", "/api/v1/studio/patterns"): [
        {"variable": "patternId", "paths": [["id"]]},
    ],
    ...
    ("GET", "/api/v1/studio/entities"): [
        {"variable": "entityId", "paths": [[0, "id"]]},
        {"variable": "entityIdsJson", "paths": [["__collect__", "id"]]},
    ],
    ("POST", "/api/v1/studio/entities"): [
        {"variable": "entityId", "paths": [["id"]]},
    ],
    ...
    ("GET", "/api/v1/studio/configurations"): [
        {"variable": "configurationId", "paths": [[0, "id"]]},
        {"variable": "configurationIdsJson", "paths": [["__collect__", "id"]]},
    ],
    ("POST", "/api/v1/studio/configurations"): [
        {"variable": "configurationId", "paths": [["id"]]},
    ],
    ...
    ("GET", "/api/v1/jobs"): [
        {"variable": "jobId", "paths": [[0, "id"]]},
        {"variable": "jobIdsJson", "paths": [["__collect__", "id"]]},
        {"variable": "findingId", "paths": [[0, "findings", 0, "id"]]},
        {"variable": "outputFilePath", "paths": [[0, "outputs", 0, "output_file_path"]]},
    ],
    ("GET", "/api/v1/jobs/{job_id}"): [
        {"variable": "jobId", "paths": [["id"]]},
        {"variable": "findingId", "paths": [["findings", 0, "id"]]},
        {"variable": "findingIdsJson", "paths": [["findings", "__collect__", "id"]]},
        {"variable": "outputFilePath", "paths": [["outputs", 0, "output_file_path"]]},
    ],
    ("POST", "/api/v1/jobs/{job_id}/review"): [
        {"variable": "jobId", "paths": [["id"]]},
        {"variable": "findingId", "paths": [["findings", 0, "id"]]},

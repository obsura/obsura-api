"""Alembic environment for Obsura API migrations."""
...
from obsura_api.db.session import load_model_metadata
...
def get_database_url() -> str:
    ...
    try:
        return Settings(auto_create_schema=False).database_url
    except Exception:

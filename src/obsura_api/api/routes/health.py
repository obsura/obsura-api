...
def version(settings: SettingsDep, container: ContainerDep) -> ApiResponse[ServiceVersionInfo]:
    ...
    return success_response(
        ServiceVersionInfo(
            ...
            document_extractor_backend=container.document_extractor.name,
            document_pdf_available=container.document_extractor.supported,
            document_max_pages=settings.max_document_pages,
            document_max_extracted_characters=settings.max_document_extracted_characters,

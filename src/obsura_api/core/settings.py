...
class Settings(BaseSettings):
    ...
    max_csv_rows: int = Field(default=10_000, ge=1, le=1_000_000)
    max_csv_columns: int = Field(default=256, ge=1, le=4_096)
    max_csv_characters: int = Field(default=250_000, ge=1)
